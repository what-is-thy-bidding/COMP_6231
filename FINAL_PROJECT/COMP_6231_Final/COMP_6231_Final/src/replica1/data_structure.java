...
public class data_structure {
	...
	private  LinkedList<String> fall_courses=new LinkedList<String>();  //LIST OF FALL COURSES
	private  LinkedList<String> winter_courses=new LinkedList<String>();//LIST OF WINTER COURSES
	private  LinkedList<String> summer_courses=new LinkedList<String>();//LIST OF SUMMER COURSES
	...
	public String drop_course_fall(String register){
		Iterator<String> it = fall_courses.iterator(); 
		while(it.hasNext() && !fall_courses.isEmpty()){
	...
	public String print(){
		String print = "\n"+username+": The List of courses Registered in : \n"+
